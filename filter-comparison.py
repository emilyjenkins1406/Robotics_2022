...
raw_data[plot_columns][plot_from:].plot(legend=False)
plt.title("Unfiltered accelerometer data from the stationary robot")
plt.xticks([])
plt.savefig("Figures/unfiltered-data.png")
plt.savefig("Figures/unfiltered-data.pdf")

filtered_data[plot_columns][plot_from:].plot(legend=False)
