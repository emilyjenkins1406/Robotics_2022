...
raw_data[plot_columns][plot_from:].plot(legend=False, title="Unfiltered accelerometer data from the stationary robot", figsize=(6, 2))
# fig.get_axes()[0].set_xticks([])
plt.xticks([])
plt.savefig("Figures/unfiltered-data.png")
plt.savefig("Figures/unfiltered-data.pdf")

filtered_data[plot_columns][plot_from:].plot(legend=False, figsize=(6, 2))
plt.title("Filtered accelerometer data from the stationary robot")
plt.xticks([])
plt.savefig("Figures/filtered-data.png")
plt.savefig("Figures/filtered-data.pdf")
